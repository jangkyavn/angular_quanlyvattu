...
@Component({
  selector: 'app-export-view-detail-modal',
  templateUrl: './export-view-detail-modal.component.html',
  styleUrls: ['./export-view-detail-modal.component.scss']
})
export class ExportViewDetailModalComponent implements OnInit {
