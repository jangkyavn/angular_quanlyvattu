...
@Component({
  selector: 'app-liquidation-detail-modal',
  templateUrl: './liquidation-detail-modal.component.html',
  styleUrls: ['./liquidation-detail-modal.component.scss']
})
export class LiquidationDetailModalComponent implements OnInit {
