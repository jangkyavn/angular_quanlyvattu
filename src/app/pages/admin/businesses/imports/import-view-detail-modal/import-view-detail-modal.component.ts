...
@Component({
  selector: 'app-import-view-detail-modal',
  templateUrl: './import-view-detail-modal.component.html',
  styleUrls: ['./import-view-detail-modal.component.scss']
})
export class ImportViewDetailModalComponent implements OnInit {
