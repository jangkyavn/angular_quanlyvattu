...
@Component({
  selector: 'app-card-inventories',
  templateUrl: './card-inventories.component.html',
  styleUrls: ['./card-inventories.component.scss']
})
export class CardInventoriesComponent implements OnInit {
  dataSet = [];
  isLoading: boolean;
  materialId: any;
  totalQuantity = 0;
