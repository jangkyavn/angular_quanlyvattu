...
@Component({
  ...
  templateUrl: './import-statistic-list.component.html',
  styleUrls: ['./import-statistic-list.component.scss']
})
export class ImportStatisticListComponent implements OnInit {
  ...
  loadData() {
    this.loading = true;
    this.statisticService.getImportStatistics(this.statisticParams)
      .subscribe((res: any[]) => {
        this.dataSet = res;
        this.loading = false;
      });
