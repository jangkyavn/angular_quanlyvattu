...
@Component({
  selector: 'app-import-statistic-detail',
  templateUrl: './import-statistic-detail.component.html',
  styleUrls: ['./import-statistic-detail.component.scss']
})
export class ImportStatisticDetailComponent implements OnInit {
  material: Material;
  totalAmount = 0;
  totalQuantity = 0;
  dataSet = [];
  ...
  ngOnInit() {
    this.route.data.subscribe(data => {
      ...
      this.route.queryParams.subscribe(params => {
        ...
        this.loadData();
        this.getTotal(this.material.maVatTu, 0);
      });
    });
  }
