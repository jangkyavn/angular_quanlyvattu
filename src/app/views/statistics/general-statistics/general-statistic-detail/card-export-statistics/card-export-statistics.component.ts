...
@Component({
  selector: 'app-card-export-statistics',
  templateUrl: './card-export-statistics.component.html',
  styleUrls: ['./card-export-statistics.component.scss']
})
export class CardExportStatisticsComponent implements OnInit {
  material: Material;
  totalAmount = 0;
  totalQuantity = 0;
  dataSet = [];
