...
@Component({
  selector: 'app-liquidation-statistic-detail',
  templateUrl: './liquidation-statistic-detail.component.html',
  styleUrls: ['./liquidation-statistic-detail.component.scss']
})
export class LiquidationStatisticDetailComponent implements OnInit {
  material: Material;
  totalAmount = 0;
  totalQuantity = 0;
  dataSet = [];
  ...
  loadData(reset: boolean = false): void {
    ...
    this.isLoading = true;
    this.materialService.getLiquidationsById(
